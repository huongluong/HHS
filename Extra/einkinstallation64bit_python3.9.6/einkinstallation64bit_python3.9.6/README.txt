eink 64-bit C/C++ library with Python wrapper module.
...
This software requires you to have a 64-bit version of Python installed (a 32-bit version of this software is also available). 
...
To install eink run the install.bat script from the command line. To uninstall run the uninstall.bat script.
...
Example:
install.bat py -3.7-32
uninstall.bat py -3.7-32
